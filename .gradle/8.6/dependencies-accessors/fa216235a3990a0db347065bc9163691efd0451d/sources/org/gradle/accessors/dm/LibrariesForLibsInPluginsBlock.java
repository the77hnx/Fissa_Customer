...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class JunitLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        private final JunitXLibraryAccessors laccForJunitXLibraryAccessors = new JunitXLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>junit.x</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public JunitXLibraryAccessors getX() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForJunitXLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class JunitXLibraryAccessors extends SubDependencyFactory {
        private final JunitX1LibraryAccessors laccForJunitX1LibraryAccessors = new JunitX1LibraryAccessors(owner);

        public JunitXLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>junit.x.1</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public JunitX1LibraryAccessors get1() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForJunitX1LibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class JunitX1LibraryAccessors extends SubDependencyFactory {

        public JunitX1LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>3</b> with <b>androidx.test.ext.junit:1.1.3</b> coordinates and
    ...
    public static class SupportLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>compat</b> with <b>com.android.support:support-compat</b> coordinates and
         * with version reference <b>supportCompat</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class XLibraryAccessors extends SubDependencyFactory {
        private final X1LibraryAccessors laccForX1LibraryAccessors = new X1LibraryAccessors(owner);
        private final X4LibraryAccessors laccForX4LibraryAccessors = new X4LibraryAccessors(owner);

        public XLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>x.1</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public X1LibraryAccessors get1() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForX1LibraryAccessors;
        }

        /**
         * Group of libraries at <b>x.4</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public X4LibraryAccessors get4() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForX4LibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class X1LibraryAccessors extends SubDependencyFactory {

        public X1LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
     ...
     */
    @Deprecated
    public static class X4LibraryAccessors extends SubDependencyFactory {

        public X4LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>1</b> with <b>androidx.appcompat:1.4.1</b> coordinates and
         * with <b>no version specified</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>glide</b> with value <b>4.8.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>supportCompat</b> with value <b>28.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getSupportCompat() { return getVersion("supportCompat"); }
